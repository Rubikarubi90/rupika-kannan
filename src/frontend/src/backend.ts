...
export class Backend implements backendInterface {
    ...
    async editTestimonial(arg0: TestimonialId, arg1: string, arg2: string, arg3: string, arg4: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.editTestimonial(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitTestimonial(arg0: string, arg1: string, arg2: string, arg3: bigint): Promise<TestimonialId> {
        if (this.processError) {
            try {
